...
class meditation(ActivityFitPluginBase):

    _application_id = bytearray(b'\x1c\xc9\x80\x99\xc0\x8bO\xc7\x91\xe6\x0f6\x15\xa3\xab,')

    _records_tablename = 'meditation_records'
    _records_version = 1
    ...
    _sessions_tablename = 'meditation_sessions'
    _sessions_version = 1
    _sessions_cols = {
